...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'moral', name: 'Moral', component: () => import('../views/evaluation/MoralEval.vue'), meta: { title: '品德发展评价', roles: ['admin', 'teacher'] } },
      { path: 'academic', name: 'Academic', component: () => import('../views/evaluation/AcademicEval.vue'), meta: { title: '学业发展评价', roles: ['admin', 'teacher'] } },
      { path: 'physical', name: 'Physical', component: () => import('../views/evaluation/PhysicalEval.vue'), meta: { title: '体能发展评价', roles: ['admin', 'teacher'] } },
      { path: 'art', name: 'Art', component: () => import('../views/evaluation/ArtEval.vue'), meta: { title: '艺术素养评价', roles: ['admin', 'teacher'] } },
      { path: 'practice', name: 'Practice', component: () => import('../views/evaluation/PracticeEval.vue'), meta: { title: '实践创新评价', roles: ['admin', 'teacher'] } },
