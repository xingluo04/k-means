<template>
  <div class="page-container">
    ...
    <el-table :data="tableData" stripe v-loading="loading" size="small">
      ...
      <el-table-column prop="artPerformance" label="美育表现分" width="100" />
      <el-table-column prop="artBonus" label="奖励分" width="80" />
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑美育评价' : '录入美育评价'" width="680px" top="3vh">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="130px" size="default">
        ...
        <el-divider content-position="left">美育表现（满分70）</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="美育表现分(70)"><el-input-number v-model="form.artPerformance" :min="0" :max="70" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
        <el-divider content-position="left">奖励分（满分30）</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="美育奖励分(30)"><el-input-number v-model="form.artBonus" :min="0" :max="30" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
        <el-divider content-position="left">扣分事项</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="美育表现扣分"><el-input-number v-model="form.artDeduction" :min="0" :max="100" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
...
const defaultForm = { id: null, studentId: null, academicYear: '2024-2025', artPerformance: 70, artBonus: 30, artDeduction: 0, remark: '' }
