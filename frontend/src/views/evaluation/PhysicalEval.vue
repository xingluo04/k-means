<template>
  <div class="page-container">
    ...
    <el-table :data="tableData" stripe v-loading="loading" size="small">
      ...
      <el-table-column prop="physicalPerformance" label="体育表现分" width="100" />
      <el-table-column prop="physicalBonus" label="奖励分" width="80" />
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑体育评价' : '录入体育评价'" width="680px" top="3vh">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="130px" size="default">
        ...
        <el-divider content-position="left">体育表现（满分80）</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="体育表现分(80)"><el-input-number v-model="form.physicalPerformance" :min="0" :max="80" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
        <el-divider content-position="left">奖励分（满分20）</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="体育奖励分(20)"><el-input-number v-model="form.physicalBonus" :min="0" :max="20" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
        <el-divider content-position="left">扣分事项</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="体育表现扣分"><el-input-number v-model="form.physicalDeduction" :min="0" :max="100" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
...
const defaultForm = { id: null, studentId: null, academicYear: '2024-2025', physicalPerformance: 80, physicalBonus: 20, physicalDeduction: 0, remark: '' }
