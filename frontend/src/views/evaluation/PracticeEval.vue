<template>
  <div class="page-container">
    ...
    <el-table :data="tableData" stripe v-loading="loading" size="small">
      ...
      <el-table-column prop="laborPerformance" label="劳动表现分" width="105" />
      <el-table-column prop="laborBonus" label="奖励分" width="80" />
      <el-table-column prop="laborDeduction" label="扣分" width="70"><template #default="{ row }"><span style="color:#ef4444">-{{ row.laborDeduction }}</span></template></el-table-column>
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑劳动教育评价' : '录入劳动教育评价'" width="680px" top="3vh">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="140px" size="default">
        ...
        <el-divider content-position="left">劳动教育表现（满分70）</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="劳动教育表现分(70)"><el-input-number v-model="form.laborPerformance" :min="0" :max="70" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
        <el-divider content-position="left">奖励分（满分30）</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="劳动教育奖励分(30)"><el-input-number v-model="form.laborBonus" :min="0" :max="30" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
        <el-divider content-position="left">扣分事项</el-divider>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="劳动教育表现扣分"><el-input-number v-model="form.laborDeduction" :min="0" :max="100" :precision="1" style="width:100%" /></el-form-item></el-col>
        </el-row>
...
const defaultForm = { id: null, studentId: null, academicYear: '2024-2025', laborPerformance: 70, laborBonus: 30, laborDeduction: 0, remark: '' }
